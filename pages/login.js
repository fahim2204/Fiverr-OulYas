                            ...
                            <form onSubmit={formik.handleSubmit} className="flex flex-col space-y-3">
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        id="username"
                                        name="username"
                                        className={`px-3 py-1 transition duration-300 border ${formik.errors.username && formik.touched.username ? 'border-rose-600' : 'border-gray-300'} rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200`}
                                        {...formik.getFieldProps('username')}
                                    />
                                    <div className='text-rose-600 text-xs mt-1'>{(formik.errors.username && formik.touched.username) && <div>{formik.errors.username}</div>}</div>
                                </div>
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        id="password"
                                        name="password"
                                        className={`px-3 py-1 transition duration-300 border ${formik.errors.password && formik.touched.password ? 'border-rose-600' : 'border-gray-300'} rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200`}
                                        {...formik.getFieldProps('password')}
                                    />
                                    <div className='text-rose-600 text-xs mt-1'>{(formik.errors.password && formik.touched.password) && <div>{formik.errors.password}</div>}</div>

                                </div>
                                {serverError && <div className="text-rose-600 text-sm text-center">
                                    {serverError}
                                </div>}
                                ...
                                <div className="flex flex-col space-y-5">
                                    ...
                                    <div className="flex items-center justify-center space-x-2">
                                        <button onClick={handleGoogleLogin} type="button" className="flex items-center justify-center px-4 py-2 hover:text-white space-x-2 transition-colors duration-300 border text-[#DB4437] border-[#DB4437] rounded-md group hover:bg-[#DB4437] focus:outline-none">
                                            <span>
