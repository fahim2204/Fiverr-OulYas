          ...
          <div className="col-span-4">
            <div className="flex flex-col items-center border rounded-xl shadow px-8 py-4">
              <div className="profile-img flex justify-center relative">
                <img className='rounded-full w-3/4 drop-shadow' src="https://studentportallaravel.fahimfaisal.net/upload/fahim.jpg" alt="profile" />
                <BiCamera
              ...
              <h3 className='text-xl font-semibold mb-3 mt-1 text-slate-800 drop-shadow'>Fahim Faisal</h3>
            </div>
          </div>
          <div className="col-span-10">
            <div className="flex flex-col border rounded-xl shadow px-8 py-4">
              <h3 className='text-center text-xl underline font-semibold drop-shadow-xl mb-6'>Profile View/Update</h3>
              ...
              <form action="#" className="flex flex-col space-y-3">
                ...
                <div className="flex flex-col space-y-3">
                  <label for="email" className="text-sm font-semibold text-gray-500">Country</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
              ...
              <div className="col-sm-9">
                ...
                <div className="flex flex-col space-y-3">
                  <div className="flex items-center justify-between">
                    <label for="password" className="text-sm font-semibold text-gray-500">Gender</label>
                  </div>
                  <select
                  className="px-3 py-1 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200"
                  name="gender"
